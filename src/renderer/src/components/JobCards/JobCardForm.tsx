                                ...
                                <div className="p-6 border-t border-gray-200">
                                    {!isPhaseUnlocked(2) ? (
                                        <div className="space-y-3">
                                            ...
                                            {/* Approval Banner — visible to Marketing Manager */}
                                            {phaseStatuses[1] === 'completed' && !customerData.marketingManagerSignature && (
                                                <div className="bg-yellow-50 border border-yellow-300 text-yellow-800 p-4 rounded-lg flex items-center justify-between shadow-sm">
                                                    <div className="flex items-center gap-3">
                                                        <svg className="w-6 h-6 text-yellow-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
                                                        <div>
                                                            <p className="font-bold text-sm">Awaiting Your Approval</p>
                                                            <p className="text-xs text-yellow-700">Phase 1 (Customer Data & Requirements) has been completed. Please review and approve to unlock Pre Press.</p>
                                                        </div>
                                                    </div>
                                                    {user?.role === 'marketing_manager' && (
                                                        <button
                                                            ...
                                                            disabled={loading}
                                                            className="ml-4 shrink-0 bg-yellow-600 hover:bg-yellow-700 text-white px-5 py-2 rounded shadow font-bold text-sm transition disabled:opacity-50"
                                                        >
                                                            ✓ Approve Phase 1
                                                        </button>
                                                    )}
                                            ...
                                            {customerData.marketingManagerSignature && (
                                                <div className="bg-green-50 border border-green-200 text-green-800 p-3 rounded flex items-center gap-2 shadow-sm">
